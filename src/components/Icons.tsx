...
import { IoLocationOutline, IoSearch, IoFilter } from 'react-icons/io5';
...
const Icon = ({ name, className, ...rest }: IconProps) => {
  switch (name) {
    ...
    case IconName.person:
      // Exported from the Figma MVP file (node 157:23843) — the glyph is drawn
      // 16x16 inside the 24 viewBox, so it inherits the design's own inset.
      return (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="1em"
